...
def test_ansi_HTML():
	...
	assert RedBackground("A short message to be colored!") == "<span style='color : Red'>A short message to be colored!</span>"
	assert GreenBackground("A short message to be colored!") == "<span style='color : Green'>A short message to be colored!</span>"
	assert BlueBackground("A short message to be colored!") == "<span style='color : Blue'>A short message to be colored!</span>"
	assert CyanBackground("A short message to be colored!") == "<span style='color : Cyan'>A short message to be colored!</span>"
	assert MagentaBackground("A short message to be colored!") == "<span style='color : Magenta'>A short message to be colored!</span>"
	assert WhiteBackground("A short message to be colored!") == "<span style='color : White'>A short message to be colored!</span>"
	assert BlackBackground("A short message to be colored!") == "<span style='color : Black'>A short message to be colored!</span>"
	assert GrayBackground("A short message to be colored!") == "<span style='color : Gray'>A short message to be colored!</span>"
	assert OrangeBackground("A short message to be colored!") == "<span style='color : Orange'>A short message to be colored!</span>"
	assert BrownBackground("A short message to be colored!") == "<span style='color : Brown'>A short message to be colored!</span>"
	assert DarkGrayBackground("A short message to be colored!") == "<span style='color : DarkGray'>A short message to be colored!</span>"